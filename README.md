...
| 1-2,4-6       | 1, 2, 4, 5, 6                                  |
> You can also input individual pages by inputting the page followed by a comma, _Page1, Page2, Page3_. 
> 
> This needs to be in the the order you want the pages to appear. If you put the same page down multiple times, it will display multiple times as well.
...
> 
> Once you have selected your pdf, it will populate the PDF Name box within the same row and update the PDF Preview.
> 
> When you open a PDF, it resets the PDF Page Selection within the same row to select all pages in the opened PDF.
### 5. Remove Buttons
> These buttons will remove the PDF within the same row
> 	- Clears the PDF Name 
> 	- Reset the PDF Page Selection back to default 
> 	- And update the PDF Preview to no longer show the removed PDF.

### 6. Apply Button
> This button will check for any changes within all of the PDF Page Selections or the PNG Page Insertion and update the PDF Preview to reflect those changes.

### 7. Merge Button
> This button will open a File Dialog Box to name and save the PDF Preview as a new PDF.
> 
...
> 
> Once you have selected your PNG, it will populate the PNG Name/Path box and update the preview to display the PNG if you have another PDF opened.
> 
> Sets the PNG Page Insertion to -1.

### 11. PNG Remove Button
> This button clears the PNG Name and PNG Insertion Point.
> 
> It will also update the PDF preview to remove the PNG.

### 12. Reset Page Selection Button
> This button resets all changes to the PNG Insertion Point and the PDF Page Selections boxes so they go back to default values.
...
> 
> The currently viewed batch does not change the PDF Page Selection.
...
> 
> PDF will be displayed in PDF Preview

### 3. Open Button
> This button opens a File Dialog Box to select a PDF.
> 
> Once you have selected your pdf, it will populate the PDF Name and displays it on the PDF Preview
...
### 5. Apply Rotate
> This button will check for any changes within the Page Rotation Selection and update the PDF Preview.
### 6. Save As Button
> This button will open a File Dialog box to name and the PDF Preview as a new PDF.
> 
...
> This button resets all changes to the Page Rotation Selection and resets the PDF Preview.
...
> Use the "Next Batch" and "Previous Batch" buttons to navigate between which 100 page section you would like to view.
> 
> The currently viewed batch does not change the Page Rotation Selection.
